    ...
    <section className="font-satoshi min-h-screen">
      <div className='flex flex-col justify-center h-screen md:px-24 px-8'>
        <div className='flex flex-col'>
          ...
          <h1 style={{ WebkitTextFillColor: 'transparent' }} className='tracking-tight bg-gradient-to-br from-dark-accent to-dark-primary mb-8 md:h-52 h-32 md:text-8xl text-6xl font-bold whitespace-pre-line bg-clip-text'>
            <TypeAnimation
              sequence={roles}
              wrapper="span"
              speed={50}
